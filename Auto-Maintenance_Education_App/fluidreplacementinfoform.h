...
/// @brief Qt Designer Form header for the Fluid Replacement information.

#ifndef FLUIDREPLACEMENTINFOFORM_H
#define FLUIDREPLACEMENTINFOFORM_H
...
namespace Ui
{
    class FluidReplacementInfoForm;
}

class FluidReplacementInfoForm : public QWidget
{
    Q_OBJECT

public:
    explicit FluidReplacementInfoForm(QWidget *parent = nullptr);
    ~FluidReplacementInfoForm();
...
public slots:
    ...
    void on_fluidReplacementQuizButton_clicked();

private:
    Ui::FluidReplacementInfoForm *ui;
};

#endif // FLUIDREPLACEMENTINFOFORM_H
